...
public class MyDefines 
{
	...
	// score for each boat
	public static int HIT_SCORE = 10;
	public static int HIT_PATROL = 20;
	public static int HIT_DESTROYER = 30;
	public static int HIT_SUBMARINE = 30;
	public static int HIT_BATTLESHIP = 40;
	public static int HIT_AIRCRAFT = 50;
}
