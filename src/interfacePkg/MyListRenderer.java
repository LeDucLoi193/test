...
public class MyListRenderer extends DefaultListCellRenderer 
{
	...
	private ArrayList<Integer> MatrixMap;	//matrix map with image types *check MapUpdateHandler.java for image index explanation
	
	public MyListRenderer(Map<String, ImageIcon> imageMap, Map<Integer, String> imageMapHelp, String appPath, ArrayList<Integer> startMatrix) 
	{
    ...
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) 
	{
        ...
        {
        	label.setIcon(this.imageMap.get(this.imageMapHelp.get(this.MatrixMap.get(index))));
        }
	...
	public void updateMatrix(ArrayList<Integer> newMatrix)
	{
